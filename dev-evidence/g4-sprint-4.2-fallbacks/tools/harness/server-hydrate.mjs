...
http.createServer(async (req, res) => {
  ...
  if (u.pathname === "/__seedcalc") {
    ...
    const calc = await post("/app/calculator", { revenue: q.revenue || "50000", currency: q.currency || "USD" });
  ...
  try {
    ...
    res.end(`<!doctype html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><title>Expense Calculator</title><meta name="shopify-api-key" content="harness"/><script src="https://cdn.shopify.com/shopifycloud/polaris.js"></script><link rel="stylesheet" href="/app.css"/></head><body><div id="root">${body}</div><script type="module" src="/entry.js"></script></body></html>`);
