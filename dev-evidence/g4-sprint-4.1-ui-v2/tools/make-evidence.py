...
# usage (repo root): python dev-evidence/g4-sprint-4.1-ui-v2/tools/make-evidence.py <commit-sha> <executed_at_utc>
import json, hashlib, re, sys

E = "dev-evidence/g4-sprint-4.1-ui-v2"
SHA = sys.argv[1]
WHEN = sys.argv[2]
...
val_files = [
    ...
    ("app/routes/app.history.tsx", "4-history"),
    ("app/routes/app.history.$id.tsx", "5-history-detail"),
    ("app/components/saved-calculation-page.tsx", "6-saved-calculation-page"),
    ("app/components/expense-breakdown.tsx", "7-expense-breakdown"),
]
...
for i, (f, slug) in enumerate(val_files):
    ...
    ref = f"shopify-dev-mcp-validate-component-codeblocks-g4-sprint-4-1-call-{slug}"
    fh = sha(f)
    summary = (
...
detail = {
    ...
    "typecheck": "react-router typegen && tsc --noEmit on the whole repo, exit 0 (dev-evidence/** is excluded from tsc as of this commit).",
    "tests": "vitest run: 38 files passed + 4 skipped; 537 tests passed + 43 skipped (skipped = opt-in real-Postgres suites, RUN_DB_TESTS=1).",
...
ev = {
    ...
    "executor": "shopify-developer-agent (Claude Code, session 93ac17bf-6bda-4fa3-8a8a-8050ec1b1b8f)",
